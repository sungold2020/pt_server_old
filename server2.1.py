...
RSSList1 = [\
    {'Name':'FRDS',  'WaitFree':False,   'Url':'https://pt.keepfrds.com/torrentrss.php?rows=10&icat=1&ismalldescr=1&isize=1&linktype=dl&passkey=97f4eab2ad32ebf39ee4889f6328800b'},\
    {'Name':'MTeam', 'WaitFree':True ,   'Url':'https://pt.m-team.cc/torrentrss.php?https=1&rows=30&cat401=1&cat419=1&cat420=1&cat421=1&cat439=1&cat403=1&cat402=1&cat435=1&cat438=1&cat404=1&cat409=1&icat=1&ismalldescr=1&isize=1&linktype=dl&passkey=7044b36a9057090e36138df761ddfc5d'},\
    {'Name':'HDSky', 'WaitFree':False,   'Url':'https://hdsky.me/torrentrss.php?rows=10&tea1=1&tea28=1&icat=1&ismalldescr=1&isize=1&linktype=dl&passkey=c8c158c14e1762b0c93c91ab2ddc689a'}]
RSSList2 = [\
    {'Name':'BeiTai',   'WaitFree':False,'Url':'https://www.beitai.pt/torrentrss.php?rows=20&icat=1&ismalldescr=1&isize=1&linktype=dl&passkey=e193420544db01e767e2a214f30ec049&inclbookmarked=1'},\
    {'Name':'LeagueHD', 'WaitFree':False,'Url':'https://leaguehd.com/torrentrss.php?rows=20&icat=1&ismalldescr=1&isize=1&linktype=dl&passkey=dfab9bb8e00a9445760abb17ec2fa772&inclbookmarked=1'},\
    {'Name':'HDHome',   'WaitFree':False,'Url':'http://hdhome.org/torrentrss.php?myrss=1&linktype=dl&uid=74129&passkey=93581f449716e0adedc71620f78513d2'},\
    {'Name':'HDArea',   'WaitFree':False,'Url':'https://www.hdarea.co/cartrss.php?rows=50&linktype=dl&passkey=cd27426c9894a4c182eb99521afd6f38&inclcarted=1'},\
    {'Name':'JoyHD',    'WaitFree':False,'Url':'https://www.joyhd.net/torrentrss.php?rows=20&icat=1&ismalldescr=1&isize=1&linktype=dl&passkey=a770594966a29653632f94dce676f3b8&inclbookmarked=1'},\
    {'Name':'SoulVoice','WaitFree':False,'Url':'http://pt.soulvoice.club/torrentrss.php?myrss=1&linktype=dl&uid=91007&passkey=2e96eb27f1e14173af82b06fecfd767d'},\
    {'Name':'PTSBao',   'WaitFree':False,'Url':'https://ptsbao.club/pushrss.php?pushkey=HvBtGW1jKCijeZMC7IPOkJaOweULzAwK2nffSx3Akw3Jb-fL0ZgHEhNVONhMiEmHD_lHAR4BwM5FDMvGRRgIhuB'},\
    {'Name':'PTHome',   'WaitFree':False,'Url':'http://pthome.net/torrentrss.php?myrss=1&linktype=dl&uid=116626&passkey=c8b0815aa8bf6f1502260a11f8ed2ed7'},\
    {'Name':'AVGV',     'WaitFree':False,'Url':'http://avgv.cc/torrentrss.php?rows=20&icat=1&ismalldescr=1&isize=1&linktype=dl&passkey=9a269ba45540e516cbf15ebf6dd815b8&inclbookmarked=1'},\
    {'Name':'FRDSMark' ,'WaitFree':False,'Url':'https://pt.keepfrds.com/torrentrss.php?rows=10&icat=1&isize=1&linktype=dl&passkey=97f4eab2ad32ebf39ee4889f6328800b&inclbookmarked=1'},\
    {'Name':'HDSkyMark','WaitFree':False,'Url':'https://hdsky.me/torrentrss.php?rows=10&icat=1&ismalldescr=1&isize=1&linktype=dl&passkey=c8c158c14e1762b0c93c91ab2ddc689a&inclbookmarked=1'},\
    {'Name':'MTeamMark','WaitFree':False,'Url':'https://pt.m-team.cc/torrentrss.php?https=1&rows=20&icat=1&ismalldescr=1&isize=1&linktype=dl&passkey=7044b36a9057090e36138df761ddfc5d&inclbookmarked=1'}]
#运行设置结束#################################################################################
...
def SaveTorrent(torrent):
    ...
    tTorrentName = re.sub(" ",".",torrent.name)                 #空格替换为.
...
def GetIDFromNfo(torrent,Index):     
    ...
    for line in open(tNfoFileName,"rb"):
        ...
        if tIndex >= 0 : DoubanLink = line[tIndex:1] 
    gRSSTorrentList[Index].DoubanID = GetIDFromLink(DoubanLink,DOUBAN)
    gRSSTorrentList[Index].IMDBID   = GetIDFromLink(IMDBLink,IMDB)
    ExecLog("DoubanLink:{} :: IMDBLink:{}".format(DoubanLink,IMDBLink))
    ExecLog("DoubanID:{} :: IMDBID:{}".format(gRSSTorrentList[Index].DoubanID,gRSSTorrentList[Index].IMDBID))
    if gRSSTorrentList[Index].DoubanID == "" and  gRSSTorrentList[Index].IMDBID == "" : return 0
    else                                                                                : return 1
            ...
            if torrent.progress == 1 :
                if GetIDFromNfo(torrent,i) > 0: 
                    ...
                    try:
                        ...
                        ExecLog("{} {} {}".format(gRSSTorrentList[i].DoubanID,gRSSTorrentList[i].IMDBID,HASH))
                        gRSSTorrentList[i].ToBeDeleted = True
                        ExecLog("success to update id:"+torrent.name)
                else  : 
                    gRSSTorrentList[i].ToBeDeleted = True
                    ExecLog("failed  get id from nfo:"+torrent.name)
            else : DebugLog("torrent have not done:"+torrent.name)
